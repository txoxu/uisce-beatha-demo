...
## 5.共通構造とUIパーツの選定
  ...
  ### ③インタラクション設計
          ...
          [カクテル一覧](https://hackmd.io/KFceLhTnQc2S_VP7P-ZAEw?edit)
          [AIに聞いてみる](https://hackmd.io/KFceLhTnQc2S_VP7P-ZAEw?edit)
          [お問い合わせ](https://hackmd.io/KFceLhTnQc2S_VP7P-ZAEw?edit)
  ### ④[fetch層/api層/action層]
## 6.[モデル・API設計(バックエンド)]
## 7.実装
## 8.レスポンシブ対応・UI最終調整
